...
// checks if the ids of milestones and activities are unique
_Bool check_id(unsigned short int id, milestone_t *milestones, int num_milestones, int current_milestone, int current_activit, bool is_milestone);
